window.onload = function () {
	...
	addBanner("img/banners/banner1.png", "img/banners/banner1.png");
	...
	var company = ["logo1.png", "logo2.png", "logo3.png", "logo4.png", "logo5.png", "logo6.png",
		"logo7.png", "logo8.png", "logo9.png", "logo10.png", "logo11.png", "logo12.png",
		"logo13.png", "logo14.png", "logo15.png"
	];
...
function createProductLink(productName) {
    const normalizedProductName = removeDiacritics(productName);
    return `chitietsanpham.html?name=${encodeURIComponent(normalizedProductName)}`;
}

// Ví dụ: Tạo liên kết cho sản phẩm
const link = createProductLink("Điện thoại Samsung Galaxy S21");
// Sử dụng biến link để tạo hyperlink trong HTML
